...
// - done:  Asserts and latches when increment reaches 20 kHz threshold. (Note, this hardcodes the sweep to 5 seconds at the growth rate).
//
// ===========================================================
...
module phase_accumulator(
    ...
    parameter [31:0] INC_20KHZ       = 32'd1_789_569_707; // increment[63:32] threshold for 20 kHz: (20000/48000)*2^32
    ...
    always @ (posedge clock or posedge reset) begin
        if (reset) begin
            ...
            if (increment[63:32] >= INC_20KHZ) // Asserts Done Signal if Increment Reaches 20 kHz Threshold.
                done <= 1'b1;
        end
    end
